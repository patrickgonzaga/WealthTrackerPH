...
class _AddStockScreenState extends ConsumerState<AddStockScreen> {
  ...
  void initState() {
    ...
    if (stock != null) {
      ...
      _avgPriceController.text = stock.avgPrice.toString();
      _currentPriceController.text = stock.currentPrice.toString();
    }
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (widget.stock != null) {
        await Supabase.instance.client.from('stocks').update(payload).eq('id', widget.stock!.id);
      } else {
        await Supabase.instance.client.from('stocks').insert(payload);
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(widget.stock != null ? 'Edit Stock' : 'Add Stock')),
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: _isLoading
                  ...
                  : Text(widget.stock != null ? 'UPDATE STOCK' : 'SAVE STOCK'),
            ),
          ],
        ),
      ),
