    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final current = crypto.quantity * crypto.currentPrice;
          final invested = crypto.quantity * crypto.avgPrice;
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        '${crypto.quantity.toStringAsFixed(8)} ${crypto.symbol}',
                      ...
                      PopupMenuButton<String>(
                        ...
                        onSelected: (value) async {
                          if (value == 'edit') {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (_) => AddCryptoScreen(crypto: crypto)),
                            );
                          }
                          ...
                          if (value == 'delete') {
                            final ok = await showDialog<bool>(
                              ...
                              builder: (_) => AlertDialog(
                                title: const Text('Delete crypto?'),
                                content: const Text('This will permanently remove this crypto entry.'),
                                actions: [
                                  TextButton(
                            ...
                            if (ok == true) {
                              try {
                                await Supabase.instance.client.from('crypto').delete().eq('id', crypto.id);
                  ...
                  Row(
                    ...
                    children: [
                      _buildInfoColumn('Avg. Cost', formatCurrency(crypto.avgPrice, decimalDigits: 2)),
                      _buildInfoColumn('Current', formatCurrency(crypto.currentPrice, decimalDigits: 2)),
                    ],
                  ),
                ],
              ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const AddCryptoScreen()),
          );
        },
